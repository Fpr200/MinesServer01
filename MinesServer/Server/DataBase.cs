...
namespace MinesServer.Server
{
    public class DataBase : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Server=DESKTOP-BORVF4Q\\SQLEXPRESS;MultipleActiveResultSets=true;Database=M;Trusted_Connection=True;TrustServerCertificate=True;");
        }
