...
namespace MinesServer.GameShit.SysMarket
{
    public static class MarketSystem
    {
        public static string PackName(int i)
        {
            string[] names =
            {
                "Телепортер","Респаун","UP","Маркет","Кланс","Плазма","Протонка","Разрядка","Кредиты","Ремонтный бот",
                ...
                "Радар вулканов","РНадар живок","Радар роботов","ТПР","Конструкционный бот","Boy gay","Zalupa Zalupa","Крафт","Магазин бомо","Пушка","Ворота","Диссамблер","Склад",
                "Сканер","x3 up","freeup","mine x4","Геопак с гипноскалом","Полимер","Нано бот","Аккумулятор","Транслятор","Компаратор","c190","Fed",
