        ...
        private Tab BuildSelltab(Player p)
        {
            ...
            return new Tab()
            {
                ...
                InitialPage = new Page()
                {
                    ...
                    Text = "Продажа кри",
                    Buttons = [new MButton("ПРОДАТЬ ВСЕ", $"sellall", (args) => MarketSystem.Sell(p.crys.cry, p, this)),
                            new MButton("ПРОДАТЬ", $"sell:{ActionMacros.CrystalSliders}", (args) => MarketSystem.Sell(args.CrystalSliders, p, this))]
                }
            };
        }
        private Tab BuildBuytab(Player p)
        {
            ...
            return new Tab()
            {
                ...
                InitialPage = new Page()
                {
                    ...
                    Text = "Покупка",
                    Buttons = [new MButton("КУПИТЬ", $"buy:{ActionMacros.CrystalSliders}", (args) => MarketSystem.Buy(args.CrystalSliders, p, this))
                        ]
                }
            };
        }
